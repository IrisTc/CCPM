    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isClaimer) {
            ...
            reportBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(TaskCreateActivity.this, ReportActivity.class);
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        if(startYear>endYear){
                            ...
                            if(startMonth>endMonth){
                                ...
                                if(startDay>=endDay) Toast.makeText(TaskCreateActivity.this,"请设置小于结束时间的日期",Toast.LENGTH_LONG).show();
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        if(startYear>endYear){
                            ...
                            if(startMonth>endMonth){
                                ...
                                if(startDay>=endDay) Toast.makeText(TaskCreateActivity.this,"请设置大于开始时间的日期",Toast.LENGTH_LONG).show();
